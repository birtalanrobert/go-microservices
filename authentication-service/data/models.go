...
// Delete deletes one user form the databas by user id
...
func (u *User) Insert(user User) (int, error) {
	...
	var newID int
	stmt := `INSERT INTO users (email, first_name, last_name, password, user_active, created_at, deleted_at) VALUES ($1, $2, $3, $4, $5, $6, $7) returning id`
...
// with the hash stored for a given user in the database. If the password
// and hash match, returns true, otherwise returns false
